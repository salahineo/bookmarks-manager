  ...
  <footer>
    <div class="container">
      <div class="row flex-column flex-sm-row align-items-center justify-content-between">
        <!-- Copyright -->
        <div class="copyright m-0 mb-3 mb-sm-0">&copy; <span id="footer-copyright-year"></span> |
          <span class="name">Mohamed Salah</span></div>
        <!-- Links -->
        <div class="links">
          ...
          <a href="https://salahineo.github.io/salahineo/" target="_blank">
            <i class="fas fa-globe-africa px-2"></i>
          </a>
  ...
  <script src="/js/swap.bookmarks.js"></script>
  <!-- End Scripts -->
</body>
</html>
